...
class CategoryObjects(RelatorN):
    ...
    """
    relCc = ('org.innoscript.desktop.schema.common.Document',
...
class Categories(RelatorN):
    ...
    """
    relCc = ('org.innoscript.desktop.schema.common.Category',)
...
class Members(RelatorN):
    ...
    """
    relCc = ('org.innoscript.desktop.schema.security.GenericUser', )
    relAttr = 'memberof'
