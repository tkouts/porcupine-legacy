...
QuiX.ui.Widget.prototype.getScreenLeft = function() {
	...
	var iX = 0, b;
	var includeBorders = !((QuiX.utils.BrowserInfo.family == 'op') ||
						   (QuiX.utils.BrowserInfo.family == 'ie' &&
							QuiX.utils.BrowserInfo.version > 7));
	var offset = (QuiX.utils.BrowserInfo.family == 'saf' ||
				  (QuiX.utils.BrowserInfo.family == 'ie' &&
				   QuiX.utils.BrowserInfo.version < 8))?1:0;
...
QuiX.ui.Widget.prototype.redraw = function(bForceAll, memo) {
	...
	if (container && this.div.style.display != 'none') {
        ...
        else if (QuiX.utils.BrowserInfo.browser == 'Safari')
		...
		try {
            ...
            if (frag || QuiX.utils.BrowserInfo.browser == 'Safari') {
...
QuiX.ui.Widget.prototype.print = function(expand) {
	...
	if (!iframe) {
		...
		function _onload() {
			...
			var n = oWidget.div.cloneNode(true);
			n.style.position = '';
			if (expand) {
				n.style.width = '';
				n.style.height = '';
