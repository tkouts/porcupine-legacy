 ...
 *
 * SWFUpload is (c) 2006-2007 Lars Huring, Olov Nilz�n and Mammon Media
 * and is released under the MIT License:
 * http://www.opensource.org/licenses/mit-license.php
 *
 * SWFUpload 2 is (c) 2007-2008 Jake Roberts and is released
...
SWFUpload.prototype.initSWFUpload = function (settings) {
    try {
        // A container where developers can place their
        // own settings associated with this instance.
        this.customSettings = {};
...
// Private: takes a URL, determines if it is relative and converts
// to an absolute URL
...
SWFUpload.prototype.initSettings = function () {
    ...
    this.settings.debug_enabled = this.settings.debug; // to maintain v2 API
    ...
    if (!this.settings.preserve_relative_urls) {
        //this.settings.flash_url = SWFUpload.completeURL(
...
// Private: loadFlash replaces the button_placeholder element
...
SWFUpload.prototype.loadFlash = function () {
    ...
    // Using innerHTML is non-standard but the only sensible way to
...
SWFUpload.prototype.getFlashVars = function () {
    ...
    return ["movieName=", encodeURIComponent(this.movieName),
            ...
            "&amp;buttonImageURL=", encodeURIComponent(
                this.settings.button_image_url),
            "&amp;buttonWidth=", encodeURIComponent(
...
// Public: getMovieElement retrieves the DOM reference
// to the Flash element added by SWFUpload
...
// Private: buildParamString takes the name/value pairs
// in the post_params setting object
...
// Public: Used to remove a SWFUpload instance from the page.
// This method strives to remove
...
/* Note: addSetting and getSetting are no longer used by SWFUpload
    but are included the maintain v2 API compatibility
*/
...
// Public: (Deprecated) getSetting gets a setting.
// Returns an empty string if the setting was not found.
...
SWFUpload.prototype.callFlash = function (functionName, argumentArray) {
    ...
    // Flash's method if calling ExternalInterface methods
    // (code adapted from MooTools).
    try {
...
// Public: cancelUpload cancels any queued file.
// The fileID parameter may be the file ID or index.
...
// Public: setButtonTextPadding changes the top and left padding
// of the text overlay
...
// Public: setButtonAction sets the action that occurs when the
// button is clicked
...
// Private: Causes the next event in the queue to be executed.
// Since events are queued using a setTimeout
...
// identifiers. To work around this the Flash Component escapes the parameter
// names and we must unescape again before passing them along.
...
// Don't modify this.
// Use the swfupload_loaded_handler event setting to execute custom
// code when SWFUpload has loaded.
...
SWFUpload.prototype.cleanUp = function (movieElement) {
    ...
    try {
        ...
        if (this.movieElement &&
            ...
            this.debug("Removing Flash functions hooks (this should only " +
                        "run in IE and should prevent memory leaks)");
...
/* Called after the file dialog has closed and the selected
    ...
    You could call startUpload here if you want the queued files
    to begin uploading immediately. */
...
// Private: debugMessage is the default debug_handler.
// If you want to print debug messages call the debug() function.
// When overriding the function your own function should
...
//
//	QuiX.utils.swfobject.addDomLoadEvent(function () {
...
//		return function () {
//			var hasFlash = QuiX.utils.swfobject.hasFlashPlayerVersion(this.settings.minimum_flash_version);
//
//			if (hasFlash) {
